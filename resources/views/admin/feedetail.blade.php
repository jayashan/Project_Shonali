                                      ...
                                      <form class="row g-3" action="{{route('feedetails.store')}}" method="POST">
                                        @csrf
                                          <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputAddress" placeholder="L00-" name="fee_id">
                                          </div>
                                          <div class="col-md-6">
                                            <label for="inputAddress" class="form-label">Record Number</label>
                                            <input type="text" class="form-control" id="inputAddress" placeholder="Record Number" name="record_number">
                                          </div>
                                          <div class="col-md-6">
                                          ...
                                          <div class="col-12">
                                            <label for="inputAddress" class="form-label">Received By</label>
                                            <input type="text" class="form-control" id="inputAddress" placeholder="Received By" name="received_by">
                                          </div>
                                          <div class="col-12">
                                            <label for="inputAddress2" class="form-label">Paid On</label>
                                            <input type="text" class="form-control" id="inputAddress2" placeholder="Paid On" name="paid_on">
                                          </div>
                                          <div class="col-12">
                                    ...
                                    <table class="table table-borderless table-striped table-earning" style="width:40%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right">Paid On</th>
